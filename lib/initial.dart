...
class _InitialPageState extends State<InitialPage> {
  ...
  void _receiveData() {
    _connection?.input?.listen(
        ...
        // Split the received data into a list of ingredients
        List<String> receivedIngredients = receivedString.split(',');

        // Process each ingredient
        for (String ingredient in receivedIngredients) {
          // Trim any extra whitespace
          ingredient = ingredient.trim();

          // Example: Print each ingredient
          print('Received Ingredient: $ingredient');

          // Now you can handle each ingredient as needed
          // For example, add it to a list, display it in the UI, etc.
        }
      },
